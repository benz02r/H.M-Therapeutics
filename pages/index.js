...
const services = [
    { id: "sports-injury", icon: "sports_kabaddi", title: "Sports Injury Relief", description: "Professional massage therapy for sports-related injuries, helping athletes recover faster and perform better." },
    { id: "relaxation", icon: "self_improvement", title: "Relaxation & Restoration", description: "Reduce stress and promote overall well-being with our expert therapeutic relaxation techniques." },
    { id: "recovery", icon: "fitness_center", title: "Tailored Recovery Programs", description: "Customized recovery plans designed to accelerate healing and prevent future injuries." },
    { id: "pain-relief", icon: "healing", title: "Effective Pain Relief Therapy", description: "Targeted massage therapy for chronic pain management and improved mobility." },
    { id: "cupping", icon: "spa", title: "Cupping Therapy for Muscle Recovery", description: "Boost circulation and reduce muscle tension with our cupping therapy services." },
    { id: "sauna", icon: "hot_tub", title: "Infrared Sauna Pod Treatment", description: "Improve circulation, detoxify, and relieve muscle stiffness with our cutting-edge sauna pod treatments." },
];
